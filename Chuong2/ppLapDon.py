from sympy import symbols, sympify, N, Interval, simplify, solveset, diff, lambdify, Abs, nsimplify, Pow, collect, ceiling, log # pyright: ignore[reportMissingModuleSource]
