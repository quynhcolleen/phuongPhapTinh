from sympy import symbols, sympify, N, Interval, simplify, solveset, diff, lambdify, Abs, S, Eq # pyright: ignore[reportMissingModuleSource]
...
class PPNewton:
    ...
    def Newton(self) -> float:
        ...
        saiSo = (M2 / (2 * m1)) * Abs(x_list[-1] - x_list[-2])**2
